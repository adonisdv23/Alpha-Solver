...
| `ALPHA-SOLVER-CALIBRATED-CONFIDENCE-OUTPUT-CONTRACT-001.md` | ALPHA-SOLVER-CALIBRATED-CONFIDENCE-OUTPUT-CONTRACT-001 | ✅ `SPEC_OK` |
| `ALPHA-SOLVER-LOCAL-OPENAI-SMOKE-RUNNER-001.md` | ALPHA-SOLVER-LOCAL-OPENAI-SMOKE-RUNNER-001 | ✅ `SPEC_OK` |
| `ALPHA-SOLVER-MODEL-CATALOG-ROUTING-METADATA-EXPANSION-001.md` | ALPHA-SOLVER-MODEL-CATALOG-ROUTING-METADATA-EXPANSION-001 | ✅ `SPEC_OK` |
| `ALPHA-SOLVER-LOCAL-MODEL-LAB-OLLAMA-SINGLEPATH-001.md` | ALPHA-SOLVER-LOCAL-MODEL-LAB-OLLAMA-SINGLEPATH-001 · Local Ollama Singlepath Lab Lane | ✅ `SPEC_OK` |
| `ALPHA-SOLVER-ESCALATION-NEEDS-HUMAN-PROTOCOL-001.md` | ALPHA-SOLVER-ESCALATION-NEEDS-HUMAN-PROTOCOL-001 · Needs-Human Escalation Protocol | ✅ `SPEC_OK` |
...
| `ALPHA-SOLVER-NARRATIVE-CLAIM-SAFETY-LINTER-001.md` | ALPHA-SOLVER-NARRATIVE-CLAIM-SAFETY-LINTER-001 · Narrative Claim-Safety Linter | ✅ `SPEC_OK` |
...
| `OPERATOR-RUN-CAPTURE-CASE-PACKET-ANCHOR-PREFLIGHT-CLI-001.md` | OPERATOR-RUN-CAPTURE-CASE-PACKET-ANCHOR-PREFLIGHT-CLI-001 · Case-Packet Anchor Preflight CLI | ✅ `SPEC_OK` |
