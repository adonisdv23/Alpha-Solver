...
This lane did not call providers, run hosted models, run local models or Ollama, execute tools, browse, use runtime GitHub APIs, mutate Sheets, add dependencies, expose dashboards/public APIs, deploy, invoke `/v1/solve`, score, unblind, inspect source maps/A-B keys, alter routed-vs-plain scores, or change scorer packets/source artifacts.
