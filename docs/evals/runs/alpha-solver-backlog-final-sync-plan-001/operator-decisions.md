...
| OPD-008 | Resolve PR #537 `/v1/solve` residual identity and tenancy questions. | Keep RR-09 as partial/current residual until a new operator/security-approved lane resolves JWT/key-to-tenant binding, TenantMiddleware mounting, JWTAuthMiddleware mounting, and gateway/operator exposure controls. | PR #537 records `DEF_002_V1_SOLVE_PARTIAL_REMEDIATION`, not `/v1/solve` readiness or DEF-002 closure. |
