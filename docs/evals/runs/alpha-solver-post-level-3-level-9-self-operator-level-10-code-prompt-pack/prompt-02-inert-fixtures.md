...
Create only inert synthetic fixtures for static Self Operator tests. Do not include secrets, credentials, provider outputs, external API responses, billing data, browser data, deployment output, or promotion labels.
