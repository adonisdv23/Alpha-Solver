# Prompt 04 artifact schema code scaffold
...
Create only inert schema-validation scaffold if separately authorized by the matched Level 10 lane. Do not implement persistence runtime or write production artifacts.
