...
Create only a local dry-run wrapper scaffold if separately authorized by the matched Level 10 lane and only after static tests exist. Do not expose routes, call providers, deploy, bill, or promote evidence.
