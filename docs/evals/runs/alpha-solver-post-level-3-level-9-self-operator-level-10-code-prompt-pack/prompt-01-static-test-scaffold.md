# prompt-01-static-test-scaffold

Create only the static Self Operator guardrail test scaffold allowed by the controlling Level 10 lane. Do not implement runtime Self Operator behavior.
