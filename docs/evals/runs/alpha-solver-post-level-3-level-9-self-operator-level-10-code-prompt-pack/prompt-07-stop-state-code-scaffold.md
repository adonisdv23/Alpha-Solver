# Prompt 07 stop-state code scaffold
...
Create only static stop-state constants or tests if separately authorized by the matched Level 10 lane. Do not implement runtime controls.
