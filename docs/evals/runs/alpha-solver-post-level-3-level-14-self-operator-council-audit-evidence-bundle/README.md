...
The earlier "Council has not run" wording in this file reflected the pre-run state and is superseded by this amendment. Manual operator review of the synthesis and the P2 hardening packet has not happened. The prior targeted Fable delta audit is cited only as having reported no P0/P1 blockers. No readiness claim is made by this amendment.
