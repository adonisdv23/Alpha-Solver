...
The selected OpenAI project boundary is not cleared by this packet.

Required operator verification before a tiny synthetic retry:

- Confirm the intended OpenAI project or project alias outside the repository.
