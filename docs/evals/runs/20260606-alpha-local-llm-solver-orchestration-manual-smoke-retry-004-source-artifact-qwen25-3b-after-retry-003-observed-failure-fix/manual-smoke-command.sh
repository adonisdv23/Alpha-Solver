...
ARTIFACT_DIR="docs/evals/runs/20260606-alpha-local-llm-solver-orchestration-manual-smoke-retry-004-source-artifact-qwen25-3b-after-retry-003-observed-failure-fix"
