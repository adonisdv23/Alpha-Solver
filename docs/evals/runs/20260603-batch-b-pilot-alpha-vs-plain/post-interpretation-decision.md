...
| `OUTPUT-DIFF-LIFT-VS-POLISH-DIAGNOSTIC-001` | Design a diagnostic plan to separate substantive lift from polish/verbosity effects. | Lift cluster +21, polish cluster -1, brevity -10, and interpretation-review discussion of lift versus polish. | Diagnostic plan only. | Ready | Not authorized: new capture until operator approves. No benchmark success claim. |
