...
| `AUDIT-005` | A | `decision_recorded` | pre-Council AUDIT-005 decision and bundle routing fix lane | future F-1 checker-scope extension lane | recorded decision in `../alpha-solver-post-level-3-level-14-self-operator-pre-council-audit-005-decision-and-bundle-routing-fix/audit-005-decision-record.md` |
