...
This guide covers how to **run**, **record**, **inspect**, and **evaluate** Alpha Solver observability: health/ready endpoints, Prometheus/Grafana, JSONL telemetry search, replay/benchmark utilities, accessibility checks, and leaderboards.
...
- The production compose stack wires Prometheus and Grafana for quick monitoring.
